...
import imgOption1 from "./Q5-option1.svg";
import imgOption2 from "./Q5-option2.svg";
import imgOption3 from "./Q5-option3.svg";
import imgOption4 from "./Q5-option4.svg";
import imgOption5 from "./Q5-option5.svg";

const options = [
  { text: "To go deeper, not wider", icon: imgOption1 },
  { text: "To stop forcing the pieces together", icon: imgOption2 },
  { text: "To see the whole map from above", icon: imgOption3 },
  { text: "To rest and reflect", icon: imgOption4 },
  { text: "To finally let something out", icon: imgOption5 },
];
